...
@Component({
  selector: 'app-send-collections',
  templateUrl: './send-collections.component.html',
  styleUrls: ['./send-collections.component.scss']
})
export class SendCollectionsComponent implements OnInit {
