...

        {
            ...
            switch (redirectTo)
            {
                ...
                case TbkRedirect.PagoRapido:
                    ...
                    redirectUrl = $"{urlPagoRapido}/#/sessions/pay/" + rutEncriptado + "/0/" + idCobranza.ToString() + "/" + idAutomatizacion.ToString();
            ...
            try
            {
                ...
                string urlFallo = sample_baseurl + $"?action=failure&idPago={idPago}&idPasarela={idPasarela}&rutCliente={rutEncriptado}&idCobranza={idCobranza}&idAutomatizacion={idAutomatizacion}&datosPago={datosPago}&redirectTo={redirectTo}&tenant={tenant}";
